...
// MCP Resources
// ---------------------------------------------------------------------------
server.resource("tokens", "lumina://design/tokens", async (uri) => ({
    contents: [{
            uri: uri.href,
...
server.resource("tailwind-config", "lumina://config/tailwind", async (uri) => ({
    contents: [{
            uri: uri.href,
...
server.resource("rules", "lumina://guidelines/rules", async (uri) => ({
    contents: [{
            uri: uri.href,
...
// MCP Tools
// ---------------------------------------------------------------------------
server.tool("get_component_snippet", {
